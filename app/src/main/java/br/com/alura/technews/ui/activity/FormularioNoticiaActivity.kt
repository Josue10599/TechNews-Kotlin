...
import br.com.alura.technews.ui.viewModel.factory.FormularioNoticiaFactory
...
class FormularioNoticiaActivity : AppCompatActivity() {
    ...
    private fun salva(noticia: Noticia) {
        viewModel.salva(noticia).observe(this, Observer { verificaErro(it, MENSAGEM_ERRO_SALVAR) })
    }
}
